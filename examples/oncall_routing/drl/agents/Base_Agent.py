...
class Base_Agent(object):
    ...
    def __init__(self, config):
        ...
        self.eval_environment = config.eval_environment
        ...
        self.total_episode_score_so_far = 0.0
    ...
    def get_state_size(self):
        ...
        return self.environment.num_states
    ...
    def reset_game(self):
        ...
        self.environment.seed(random.randint(1,100))
    ...
    def print_rolling_result(self):
        ...
        text = """"\r Episode {0}, Score: {3: .2f}, Max score seen: {4: .2f}, Rolling score: {1: .2f}, Max rolling score seen: {2: .2f}\r"""
